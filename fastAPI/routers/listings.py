...
async def load_listings_to_cache(db: AsyncSession, redis):
    ...
    for listing in listings:
        ...
        listing_data = {
            ...
            "is_visible": getattr(listing, 'is_visible', True),  # Default to True for old records
...
@router.get("/listings/filter-options", response_model=FilterOptionsResponse)
async def get_filter_options(
    ...
    # We need to aggregate all platform_ids from the JSON arrays
